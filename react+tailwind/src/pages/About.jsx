...
const About = () => {
  ...
  const tabOne = {
    title: "Curious. Creative. Code-driven.",
    sentence:
      " Hi, I'm Jun Dejolde, aspiring software engineer exploring the world of coding through creativity and hands on project.This website is a part of my journey to be a software engineering someday.",
  };
